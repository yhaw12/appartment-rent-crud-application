...
<div style="background-image: url('/appartment1.jpeg'); background-size: cover; background-position: center;  background-repeat: no-repeat;">
    <div id="appartmentList" class="w-full h-auto mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4 cursor-pointer" >
